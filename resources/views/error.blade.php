        ...
        <div class="container">
            <div class="text-center mb-5">
                <div class="success-gif m-auto">
                  <img class="w-2 h-2" src="{{asset('site/error.png')}}" alt="">
                </div>
                <h4 class="mb-4">حدث خطأ اثناء اتمام الدفع</h4>
                <p class="mb-1">
                  من فضلك اعد عملية الشراء مرة اخرى
                </p>
                <p>برجاء التاكد من بيانات حسابك</p>
                <a href="{{route('paypal')}}" class="btn btn-primary">شراء منتجات اخري</a>
              </div>
